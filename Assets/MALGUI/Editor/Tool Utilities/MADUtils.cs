...
namespace MADUtils { 
    ...
    /// </summary>
    public class GenericPreview : Object {
        ...
        /// <param name="reference"> The field to reset when the object is destroyed; </param>
        public GenericPreview(Object previewObject) {
            preview = Editor.CreateEditor(previewObject);
        }
        ...
        /// </summary>
        public void CleanUp(ref GenericPreview reference) {
    ...
    /// </summary>
    public class MaterialEditorBundle : Object {

        public MaterialEditor editor;

        public MaterialEditorBundle(Material material) {
            editor = Editor.CreateEditor(material, typeof(MaterialEditor)) as MaterialEditor;
        }
        ...
        public void CleanUp(ref MaterialEditorBundle reference) {
